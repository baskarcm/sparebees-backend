                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-3">
                                    <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
                                        ...
                                        <li class="nav-item border rounded mb-1">
                                            <a class="nav-link" id="database-generate-tab" data-toggle="tab" href="#databaseGenerateTab" role="tab" aria-controls="facebookPixelTab" aria-selected="true">{{__('admin.Database Generate')}}</a>
                                        </li>
                                                ...
                                                <div class="card m-0">
                                                    <div class="card-body">
                                                        <form action="{{ route('admin.update-database') }}" method="POST">
                                                            ...
                                                            <button class="btn btn-primary">{{__('admin.Database Generate')}}</button>
                                                    </form>
                                                    </div>
                                                </div>
                                            </div>
