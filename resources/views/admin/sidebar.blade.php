      ...
      <ul class="sidebar-menu">
          ...
          <li class="nav-item dropdown {{ Route::is('admin.delivery-man-withdraw-method.*') || Route::is('admin.delivery-man-withdraw') || Route::is('admin.show-delivery-man-withdraw') || Route::is('admin.pending-delivery-man-withdraw') ? 'active' : '' }}">
            ...
            <ul class="dropdown-menu">
                ...
                <li class="{{ Route::is('admin.delivery-man-withdraw-method.index') || Route::is('admin.delivery-man-withdraw-method.create') || Route::is('admin.delivery-man-withdraw-method.edit') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.delivery-man-withdraw-method.index') }}">{{__('Withdraw Method')}}</a></li>
